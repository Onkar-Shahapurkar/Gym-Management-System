...
public class Warmup extends JFrame
{
    Font f;
    ...
    Warmup()
    {
      super("Warmup Exercise Images");
      setSize(1900,1020);
      setLocation(0,0);
      
      f= new Font("Lucida Fax",Font.BOLD,35);
      
      ImageIcon img1 = new ImageIcon("D://Programming//Main Projects//Gym Management System//Warmup//Warmup1.jpg");
      Image im1 = img1.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      l1 = new JLabel(new ImageIcon(im1));
      
      ImageIcon img2 = new ImageIcon("D://Programming//Main Projects//Gym Management System//Warmup//Warmup2.jpg");
      Image im2 = img2.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      l2 = new JLabel(new ImageIcon(im2));
      
      ImageIcon img3 = new ImageIcon("D://Programming//Main Projects//Gym Management System//Warmup//Warmup3.gif");
      Image im3 = img3.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      l3 = new JLabel(new ImageIcon(im3));
      
      ImageIcon img4 = new ImageIcon("D://Programming//Main Projects//Gym Management System//Warmup//Warmup4.jpg");
      Image im4 = img4.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      l4 = new JLabel(new ImageIcon(im4));
      
      ImageIcon img5 = new ImageIcon("D://Programming//Main Projects//Gym Management System//Warmup//Warmup5.gif");
      Image im5 = img5.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      l5 = new JLabel(new ImageIcon(im5));
      
      ImageIcon img6 = new ImageIcon("D://Programming//Main Projects//Gym Management System//Warmup//Warmup6.jpg");
      Image im6 = img6.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      l6 = new JLabel(new ImageIcon(im6));
      
      ImageIcon img7 = new ImageIcon("D://Programming//Main Projects//Gym Management System//Warmup//Warmup7.jpg");
      Image im7 = img7.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      l7 = new JLabel(new ImageIcon(im7));
      
      ImageIcon img8 = new ImageIcon("D://Programming//Main Projects//Gym Management System//Warmup//Warmup8.gif");
      Image im8 = img8.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
      l8 = new JLabel(new ImageIcon(im8));
      
      l9 = new JLabel("WARMUP EXERCISE IMAGES");
      l9.setFont(f);
