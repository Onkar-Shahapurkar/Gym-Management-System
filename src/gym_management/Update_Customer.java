...
public class Update_Customer extends JFrame implements ActionListener, KeyListener
{
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15;
    JTextField tf1,tf2,tf3,tf4,tf5,tf6,tf7,tf8,tf9,tf10;
    Choice ch0,ch1,ch2,ch3,ch4;
    ...
    public Update_Customer()
    {
      ...
      l14 = new JLabel("Update the Trainee");
      ...
      try
      {
         ...
         while(rest.next())
         {
           ch0.add(rest.getString("receipt_no"));
         }
      }
      catch(Exception ex)
       {
       ...
       ch0.addMouseListener(new MouseAdapter()
       {
          public void mouseClicked(MouseEvent arg0)
          {
             try
             {
               ...
               int receipt_no = Integer.parseInt(ch0.getSelectedItem());
               String q2 = "select * from add_customer where receipt_no="+receipt_no+";";
               ResultSet rest2=obj2.stmt.executeQuery(q2);
               while(rest2.next())
               {
                tf1.setText(rest2.getString("name"));
                tf2.setText(rest2.getString("surname"));
                tf3.setText(rest2.getString("email"));
                tf4.setText(rest2.getString("address"));
                tf5.setText(rest2.getString("contact"));
                tf7.setText(rest2.getString("height"));
                tf8.setText(rest2.getString("weight"));
                tf9.setText(rest2.getString("remarks"));
               }
             }
             catch(Exception ex1)
             {
    ...
    try
    {
     ...
     if(e.getSource()==bt1)
     {
        ...
        if (!mobilevalid(g))
        {
         JOptionPane.showMessageDialog(Update_Customer.this,"Enter Proper Contact Number !!!");
         tf5.requestFocus();
        }
        else if(!emailvalid(emaill))
        {
         JOptionPane.showMessageDialog(Update_Customer.this,"Enter Proper Email !!!");
         tf3.requestFocus();
        }
        else
        {
           ...
           int rid = Integer.parseInt(ch0.getSelectedItem());
           ...
           String tname = ch4.getSelectedItem();
            ...
            String q = "update add_customer set name='"+name+"', surname='"+surname+"',email='"+email+"',address='"+address+"',contact='"+cont+"',payment_plan='"+plan+"',gender='"+gender+"',height="+height+",weight="+weight+",remarks='"+remarks+"',trainer_name='"+tname+"',category='"+category+"' where receipt_no="+rid+";";
