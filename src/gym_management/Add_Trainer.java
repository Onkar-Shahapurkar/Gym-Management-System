...
public class Add_Trainer extends JFrame implements ActionListener, KeyListener
{
    ...
    public Add_Trainer()
    {
      ...
      setLocation(10,10);
      setResizable(true);
      ImageIcon img = new ImageIcon("D://Programming//Main Projects//Gym Management System//trainer.png");
    ...
    public void actionPerformed(ActionEvent e)
    {
     if(e.getSource()==bt1)
     {
        ...
        if (!mobilevalid(g))
        {
         JOptionPane.showMessageDialog(Add_Trainer.this,"Enter Proper Contact Number !!!");
         tf5.requestFocus();
        }
        else if (!mobilevalid(emerg))
        {
         JOptionPane.showMessageDialog(Add_Trainer.this,"Enter Proper Emergency Number !!!");
         tf6.requestFocus();
        }
        else if(!emailvalid(emaill))
        {
         JOptionPane.showMessageDialog(Add_Trainer.this,"Enter Proper Email !!!");
         tf3.requestFocus();
        }
        else
        {
